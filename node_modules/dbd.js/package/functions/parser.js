const Parser = {
  ...
  $creationDate:
    "Returns the creation date of given channel, guild, emoji, user or role ID.;$creationDate[emojiID/userID/roleID/channelID/guildID;date/time/ms (optional)]",
  $userRoles:
...
*/
  ...
  $getCooldownTime:
    "Gets a command cooldown time left for a type;$getCooldownTime[globalUser/user/server;command name;ID;return ms (yes/no) (optional)]",
  $timeoutData:
