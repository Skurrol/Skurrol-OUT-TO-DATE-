...
module.exports = class DatabaseTable {
    ...
    _start() {
        ...
        console.log(`Table ${this.name} ready`)
    ...
    async _get(data) {
        ...
        console.log(`Finished getting ${items} items in ${Date.now() - start}ms.`)
    ...
    async _all(data) {
        ...
        for (const path of [...this.files.keys()]) {
            ...
            all = Object.assign(Object.create(all), raw)
        }
    ...
    async _delete(data) {
        ...
        console.log(`Starting to delete ${items} items from the table ${this.name}...`)
        ...
        console.log(`Finished deleting ${items} items from table ${this.name} in ${Date.now() - start}ms`)
